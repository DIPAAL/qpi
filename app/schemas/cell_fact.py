...
class FactCell(BaseModel):
    ...
    direction: Direction = Field(description='Describes the coordinal direction which the ship entered and exited the cell')  # noqa: E501
    sog: float = Field(description='The speed over ground of the ship while within the cell')
    delta_cog: float = Field(description='Describes how much the course over ground of the ship changed while within the cell')  # noqa: E501
